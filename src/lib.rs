...
#[derive(Debug)]
pub struct AnimeSearchProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AnimeSearchProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AnimeSearch processing");
    
    let mut processor = AnimeSearchProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AnimeSearchProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AnimeSearchProcessor::new(false);
